...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='usersubscription',
            name='plan',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='billing.plan'),
        ),
        migrations.AddField(
            model_name='usersubscription',
            name='updated_by',
        ...
        migrations.AddConstraint(
            model_name='usersubscription',
            constraint=models.UniqueConstraint(fields=('user', 'plan'), name='unique_user_plan_subscription'),
        ),
    ]
